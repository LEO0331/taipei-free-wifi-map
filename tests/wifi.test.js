...
import { buildWifiSummary, calculateDistanceMeters, classifyWifiHotspotType, filterWifiHotspots, formatDistance, getGoogleMapsUrl, normalizeArea, normalizeColumnName, parseCoordinate, validateWifiCoordinate, } from '../src/lib/wifi.js';
const hotspot = (overrides = {}) => ({
    id: 'site-1',
    siteId: 'site-1',
    hotspotTypeZh: '圖書館',
